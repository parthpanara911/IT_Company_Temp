                    ...
                    <div class="row">
                        <div class="col-lg-8 m-auto">
                            <div class="about-banner-content text-center">
                                <h1 class="mb-15 text-white">About Sunfloweebiztech</h1>
                                <h5 class="font-weight--normal text-white">Sunfloweebiztech specializes in technological and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc. </h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 offset-lg-1">
                                <div class="cybersecurity-about-text">
                                    <div class="text">Sunfloweebiztech specializes in technological and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc. We put a strong focus on the needs of your business to figure out solutions that best fits your demand and nail it.</div>
                            ...
                            <div class="delivering-optimal-wrap">
                                ...
                                <div class="list-item">
                                    ...
                                    <div class="title-wrap">
                                        ...
                                        <div class="desc">At Sunfloweebiztech, we have a holistic and integrated approach towards core modernization to experience technological evolution. </div>
                                    </div>
                                </div>
                                <div class="list-item">
                                    <div class="marker"></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title-wrap text-center section-space--mb_40">
                                ...
                                <h3 class="heading">What do people praise about <span class="text-color-primary"> Sunfloweebiztech?</span></h3>
                            </div>
                                    ...
                                    <div class="swiper-wrapper testimonial-slider__wrapper">
                                        <div class="swiper-slide">
                                            <div class="testimonial-slider__one wow move-up">
                                                ...
                                                <div class="testimonial-slider__text">I’ve been working with over 35 IT companies on more than 200 projects of our company, but @Sunfloweebiztech is one of the most impressive to me.</div>
                                        ...
                                        <div class="content-wrap">
                                            <div class="content">
                                                ...
                                                <div class="main-content">
                                                    ...
                                                    <div class="text">90993 67675</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="content-wrap">
                                            <div class="content">
                                                ...
                                                <div class="main-content">
                                                    ...
                                                    <div class="text">hello@sunfloweebiztech.com</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
...
<!-- Mirrored from htmldemo.net/mitech/about-us-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2023 09:28:42 GMT -->
