                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="section-title small-mb__40 tablet-mb__40">
                                    ...
                                    <p class="text mt-20">Sunfloweebiztech specializes in technological and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc. We put a strong focus on the needs of your business to figure out solutions that best fits your demand and nail it.</p>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="#" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                ...
                                                <div class="content">
                                                    <h6 class="heading">Sunfloweebiztech-Smart Vision</h6>
                                                    <div class="post-categories">Cyber Security</div>
                                                    <div class="text">At Sunfloweebiztech, we have a holistic and integrated approach towards core modernization to experience technological evolution.
                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title-wrap text-center section-space--mb_60">
                                ...
                                <h3 class="heading">Why do people praise about<span class="text-color-primary"> Sunfloweebiztech?</span></h3>
                            </div>
                                    ...
                                    <div class="swiper-wrapper testimonial-slider__wrapper">
                                        <div class="swiper-slide">
                                            <div class="testimonial-slider__single wow move-up">
                                                <h6 class="testimonial-subject">The Sunfloweebiztech team works really hard to ensure high level of quality</h6>
                                                <div class="testimonial-slider__text">There are thousands of IT service companies in the India. But there’s nothing like @Sunfloweebiztech. Their popularity and reputation are just evident. </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testimonial-slider__single wow move-up">
                                                <h6 class="testimonial-subject">The Sunfloweebiztech team works really hard to ensure high level of quality</h6>
                                                <div class="testimonial-slider__text">I discovered @Sunfloweebiztech services by chance on the Internet to find a suitable IT services provider. This must be fate, not an accident at all.</div>
                                                <div class="author-info">
                                                    <div class="testimonial-slider__media">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testimonial-slider__single wow move-up">
                                                <h6 class="testimonial-subject">The Sunfloweebiztech team works really hard to ensure high level of quality</h6>
                                                <div class="testimonial-slider__text">There are thousands of IT service companies in the US. But there’s nothing like @Sunfloweebiztech. Their popularity and reputation are just evident. </div>
                                                <div class="author-info">
                                                    <div class="testimonial-slider__media">
